        ...
        child: Center(
          child: SingleChildScrollView(
            child: Column(
              children: [
                SizedBox(height: 20,),
                Image.asset('images/paw.png', height: 50, width: 50, color: Colors.black),
                SizedBox(height: 10,),
                Text("Register your Pet",style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                SizedBox(height: 20,),
                Text("Pet Owner Information",style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),),
                SizedBox(height: 20,),
                Container(
                        child: Form(
                          key: _form,
                ...
                Text("Pet Information",style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),),
                Container(
                  padding: EdgeInsets.symmetric(horizontal: 10,vertical: 5),
                  child: TextFormField(
                    controller: _petname,
                    ...
                    decoration: InputDecoration(
                        border: InputBorder.none,
                        prefixIcon: Icon(Icons.pets, size: 30,color: Colors.black
                          ,),
                        labelText: "Pet Name",
                        labelStyle: TextStyle(
                          fontSize: 15,
                ...
                SizedBox(height: 50,width: 200,
                  child: RaisedButton(
                    ...
                    onPressed: () {
                      ...
                      showDialogFunc(context,  firstname, lastname, emailaddress, address, phone, petname, petbreed, "", "This is your QR Code for your Pet");
...
showDialogFunc(context, firstname, lastname, emailaddress, address, phone, petname, petbreed, text, desc) {
              ...
              children: <Widget>[
                ClipRRect(
                  borderRadius: BorderRadius.circular(5),
                    child: QrImage(
                      data: "First Name: " + firstname + " Last Name: " + lastname + "Email Address: " + emailaddress + "Address: " + address +
                      "Contact Number: " + phone + "Pet Name: " + petname + "Pet Breed: " + petbreed,
