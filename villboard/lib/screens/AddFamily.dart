            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  SizedBox(height: 10,),
                  Text("Add a member of the house",style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                  SizedBox(height: 20,),
                  Text("Family Member Information",style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold),),
                  SizedBox(height: 20,),
                  Container(
